...
const Overtime = React.lazy(() => import('./views/theme/overtime/Overtime'));
const SalaryManagement = React.lazy(() => import('./views/salary/SalaryManagement'));
...
const routes = [
  ...
  { path: '/salary-management', name: 'Salary Management', component: SalaryManagement },
